...
<!-- Interoception -->
We also showed that interoceptive abilities (as indicated by the composite interoception scores) are correlated with a higher confidence in one's lies in the polygraph condition, a condition in which the attention towards internal reactions is fostered. Indeed, this is in line with previous studies that found individuals with low interoception were more aversed to risk when reputational stakes were high, telling fewer egoistical lies [@vabba2022interoceptive]. In fact, @vabba2022interoceptive further reports that people with high interoception abilities were less likely to differ in risk-taking tendencies, telling the same number of lies regardless of the social stakes. However, in contrast to previous studies [@pinna2020systematic; @fustos2013embodiment; @owens2018investigating; @pollatos2007heart], we did not find any significant relationship between individuals' interoception scores and their heart rate changes during their answers. This points toward a predominantly meta-cognitive effect without necessarily an actual bodily regulation (i.e., participants with good interoception feel that their lies are more convincing, but do not actively attenuate their bodily reactions). 
...
To account for the lack of validated self-report measures for assessing healthy adults' perspectives of their ToM skills, the BES, which is designed to measure empathy, was administered. While ToM and empathy are closely related constructs, evidence nonetheless suggests the two concepts are necessarily distinct, with separable underlying mechanisms [@kanske2015dissecting]. Given recent developments in the creation of validated and sensitive indices of ToM (such as the Theory of Mind Inventory:Self-Report, @hutchins2021development), future studies are warranted to further investigate the associations between ToM and lying ability. Additionally, our application of feature reduction as a noise-elimination measure could have over-simplified the data. A more complex pattern of relationships, with different contributions of various subdimensions of ToM and interoception, could emerge provided a sufficient statistical power and valid measures.
